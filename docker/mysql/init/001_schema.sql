...
CREATE TABLE IF NOT EXISTS tb_event (
    ...
    artist VARCHAR(64) NOT NULL DEFAULT '' COMMENT 'Artist or performer',
    city VARCHAR(64) NOT NULL COMMENT 'Event city',
    venue VARCHAR(128) NOT NULL COMMENT 'Event venue',
    ...
    create_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Create time',
    update_time DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Update time',
    KEY idx_event_status_time (status, event_time),
    KEY idx_event_city_time (city, event_time),
    KEY idx_event_artist (artist),
    FULLTEXT KEY ft_event_title_artist_venue (title, artist, venue)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Concert or event';
